// bid controller - blind bidding system
'use strict'

var { Op } = require('sequelize');
var Bid = require('../../models/Bid');
var FeaturedAlumni = require('../../models/FeaturedAlumni');
var { Event, EventAttendee } = require('../../models/Event');
var { Profile } = require('../../models/Profile');
var { isAuthenticated } = require('../../middleware/auth');

exports.setup = function(app) {

  // get bidding page data (todays status, history, featured)
  app.get('/bids', isAuthenticated, async function(req, res) {
    try {
      ...
      // event attendance bonus - check if user attended any event this month
  ...
  // place or update bid
  app.post('/bid', isAuthenticated, async function(req, res) {
    try {
      var userId = req.session.userId;
  ...
  // full bid history
  app.get('/bid/history', isAuthenticated, async function(req, res) {
    try {
