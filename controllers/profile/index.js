// profile controller - alumni profile CRUD
'use strict'
...
exports.setup = function(app) {
  ...
  // get my profile
  app.get('/profile/me', isAuthenticated, async function(req, res) {
    try {
  ...
  app.get('/profile/:profile_id', async function(req, res) {
    try {
      var profile = await Profile.findOne({
  ...
  app.post('/profile', isAuthenticated, upload.single('profileImage'), async function(req, res) {
    try {
      ...
      // fetch updated profile with all includes
  ...
  // delete a sub entry (degree, cert etc)
  app.delete('/profile/entry/:type/:entry_id', isAuthenticated, async function(req, res) {
    try {
      var modelMap = {
